package com.example.mrtian.joke.view;

/**
 * Created by mrtian on 2016/3/7.
 */
...
public class CalendarView extends View implements View.OnTouchListener {
    ...
    private class Surface {
        ...
        public int bgColor = Color.parseColor("#3CB371");
        private int textColor = Color.parseColor("#FFFFFF");
        //private int textColorUnimportant = Color.parseColor("#666666");
        private int btnColor = Color.parseColor("#666666");
        private int borderColor = Color.parseColor("#d4d4d4");
        public int todayNumberColor = Color.YELLOW;
